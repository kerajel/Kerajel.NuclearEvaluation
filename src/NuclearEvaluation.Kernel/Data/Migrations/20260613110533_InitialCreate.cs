...
namespace NuclearEvaluation.Kernel.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.EnsureSchema(name: "EVALUATION");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FollowUpActionsRecommended = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table
                        .Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LastResetUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SandboxState", x => x.Id);
                }
            );
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SgasComment = table.Column<string>(
                        type: "nvarchar(4000)",
                        maxLength: 4000,
                        nullable: false
                    ),
                    WorkingPaperLink = table.Column<string>(
                        type: "nvarchar(200)",
                        maxLength: 200,
                        nullable: false
                    ),
                    ...
                    AnalysisCompleteDate = table.Column<DateTime>(
                        type: "datetime2",
                        nullable: true
                    ),
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SerializedDescriptors = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: false
                    ),
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivityNotes = table.Column<string>(
                        type: "nvarchar(4000)",
                        maxLength: 4000,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    U234 = table.Column<decimal>(
                        type: "decimal(38,15)",
                        precision: 38,
                        scale: 15,
                        nullable: true
                    ),
                    ErU234 = table.Column<decimal>(
                        type: "decimal(38,15)",
                        precision: 38,
                        scale: 15,
                        nullable: true
                    ),
                    U235 = table.Column<decimal>(
                        type: "decimal(38,15)",
                        precision: 38,
                        scale: 15,
                        nullable: true
                    ),
                    ErU235 = table.Column<decimal>(
                        type: "decimal(38,15)",
                        precision: 38,
                        scale: 15,
                        nullable: true
                    ),
                    U236 = table.Column<decimal>(
                        type: "decimal(38,15)",
                        precision: 38,
                        scale: 15,
                        nullable: true
                    ),
                    ErU236 = table.Column<decimal>(
                        type: "decimal(38,15)",
                        precision: 38,
                        scale: 15,
                        nullable: true
                    ),
                    U238 = table.Column<decimal>(
                        type: "decimal(38,15)",
                        precision: 38,
                        scale: 15,
                        nullable: true
                    ),
                    ErU238 = table.Column<decimal>(
                        type: "decimal(38,15)",
                        precision: 38,
                        scale: 15,
                        nullable: true
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table
                        ...
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SubSampleId = table.Column<int>(type: "int", nullable: false),
                    ParticleExternalId = table.Column<decimal>(
                        type: "decimal(10,2)",
                        precision: 10,
                        scale: 2,
                        nullable: false
                    ...
                    IsNu = table.Column<bool>(type: "bit", nullable: false),
                    LaboratoryCode = table.Column<string>(
                        type: "nvarchar(15)",
                        maxLength: 15,
                        nullable: false
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "Apm", schema: "DATA");

            migrationBuilder.DropTable(name: "Particle", schema: "DATA");

            migrationBuilder.DropTable(name: "PresetFilterEntry", schema: "EVALUATION");

            migrationBuilder.DropTable(name: "ProjectSeries", schema: "EVALUATION");

            migrationBuilder.DropTable(name: "SandboxState", schema: "DBO");

            migrationBuilder.DropTable(name: "SubSample", schema: "DATA");

            migrationBuilder.DropTable(name: "PresetFilter", schema: "EVALUATION");

            migrationBuilder.DropTable(name: "Project", schema: "EVALUATION");

            migrationBuilder.DropTable(name: "Sample", schema: "DATA");

            migrationBuilder.DropTable(name: "Series", schema: "DATA");
        }
    }
}
